...
public static class DebugExtension
{
    ...
    //private static bool colorSwitch = true;
    ...
    public static void DebugLine(Vector2 A, Vector2 B, Color color1, Color color2, ref bool colorSwitch, float duration = 0, bool depthTest = true)
    {
        Debug.DrawLine(A, B, colorSwitch ? color1 : color2, duration, depthTest);
    ...
    /// Debugs a line
    /// </summary>
    /// <param name="Linea">List of points from the line.</param>
    /// <param name="color1">Color 1</param>
    /// <param name="color2">Color 2</param>
    /// <param name='duration'>How long to draw the Line.</param>
    /// <param name='depthTest'>Whether or not this line should be faded when behind other objects.</param>
    public static void DebugLine(List<Vector2> Linea, Color color1, Color color2, float duration = 0, bool depthTest = true)
    {
        if (Linea != null && Linea.Count > 0)
        {
            ...
            {
                DebugLine(vP, Linea[i], color1, color2, ref colorSwitch, duration, depthTest);
    ...
    /// <param name='duration'>How long to draw the Line.</param>
    /// <param name='depthTest'>Whether or not this line should be faded when behind other objects.</param>
    public static void DebugLine(List<Vector2> Linea, Color color, float duration = 0, bool depthTest = true)
    {
        if (Linea != null && Linea.Count > 0)
        {
            Vector2 vP = Linea[0];
            for (int i = 1; i < Linea.Count; i++)
            {
                Debug.DrawLine(vP, Linea[i], color, duration, depthTest);
